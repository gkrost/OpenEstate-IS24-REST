...
/**
 * <p>Java class for CountryRegion complex type</p>.
 * 
...
public class CountryRegion implements Serializable, Cloneable, CopyTo, Equals, ToString
{

    /**
     * Der ISO-3 Ländercode.
     * 
     */
    ...
    /**
     * Deutscher Name der Region des Landes. Mögliche Namen
     *                         sind über die Online-API-Dokumentation abrufbar.
     * 
     */
    @XmlElement(required = true)
