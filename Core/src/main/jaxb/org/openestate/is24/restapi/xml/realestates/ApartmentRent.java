 ...
 * 
 * <p>Java class for ApartmentRent complex type</p>.
 * 
    ...
    implements Serializable, Cloneable, CopyTo, Equals, ToString
{
    ...
    /**
     * Jahr der letzte Modernisierung
     * 
     */
    @XmlElement(type = String.class)
