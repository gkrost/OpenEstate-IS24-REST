...
public class Regions implements Serializable, Cloneable, CopyTo, Equals, ToString
{
     ...
     * This is why there is not a {@code set} method for the region property.</p>
     * 
     * <p>
    ...
    @XmlType(name = "")
    @Generated(value = "com.sun.tools.xjc.Driver", comments = "JAXB RI v4.0.9", date = "2026-08-26T20:20:00+02:00")
    public static class Region implements Serializable, Cloneable, CopyTo, Equals, ToString
    {
